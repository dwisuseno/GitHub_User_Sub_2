...
import db.DatabaseContract.FavColumns.Companion.USERNAME
import db.DatabaseContract.FavColumns.Companion._ID
...
class FavHelper(context: Context) {
    ...
    fun queryByUsername(uname: String): Cursor {
        return database.query(
            DATABASE_TABLE,
            null,
            "$USERNAME = ?",
    ...
    fun removeByUsername(uname: String): Int{
